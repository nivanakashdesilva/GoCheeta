    ...
    if ($front_error === 0 && $leftside_error === 0 && $rightside_error === 0 && $rear_error === 0) {
        ...
        if ($front_img_size > 125000 && $leftside_img_size > 125000 && $rightside_img_size > 125000 && $rear_img_size > 125000 ) {
            ...
            if(in_array($front_img_ex_lc, $allow_exs)){
                            ...
                            mysqli_query($conn, "insert into vehical_detail (vehical_make, vehical_model, vehical_year, vehical_number, number_of_seats, vehical_chasie_number, vehical_insurance_provider, vehical_insurance_policy_number, vehical_front_image, vehical_leftside_image, vehical_rightside_image, vehical_rear_image, vehical_color, vehical_added_date)
                                                            values('$vehical_make', '$vehical_model', '$vehical_year', '$vehical_number', '$number_of_seats', '$vehical_chasie_number', '$vehical_insurance_provider','$vehical_insurance_policy_number', '$front_new_img_name', '$leftside_new_img_name', '$rightside_new_img_name', '$rear_new_img_name','$vehical_color', NOW())");
                            header("location: add_vehical.php");
